---
id: 732
title: '[FreeBSD] wxWidgets must be installed on your system'
date: 2010-09-17T17:51:18+00:00
author: SAWP
layout: post
guid: http://www.sawp.com.br/blog/?p=732
permalink: p=732
...
> `wxWidgets must be installed on your system<br />
but either the wx-config script couldn't be found or<br />
no compatible wxWidgets configuration has been insalled.<br />
Compatible wxWidgets configurations are the unicode builds<br />
of wxGTK, wxMac and wxMSW.<br />
Please check that wx-config is in path, the directory<br />
where wxWidgets libraries are installed (returned by<br />
'wx-config --libs' command) is in LD_LIBRARY_PATH or<br />
equivalent variable and wxWidgets version is 2.8.9 or above.` 

Install

<center>
  <code>/usr/ports/x11-toolkits/wxgtk28</code>
</center>

and make a symbolic link

<center>
  <code>ln -S /usr/local/bin/wxgtk2-2.8-config /usr/local/bin/wx-config</code>
</center>

and

<center>
  <code>ln -s /usr/local/bin/wxrc-gtk2u-2.8 /usr/local/bin/wxrc</code>
</center>
