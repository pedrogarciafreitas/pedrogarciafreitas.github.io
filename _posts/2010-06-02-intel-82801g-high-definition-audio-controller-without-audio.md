---
id: 639
title: Intel 82801G High Definition Audio Controller without audio?
date: 2010-06-02T13:38:24+00:00
author: SAWP
layout: post
guid: http://www.sawp.com.br/blog/?p=639
permalink: /p=639
...
categories:
  - FreeBSD
---
If your sound device is:

> `<br />
cat /dev/sndstat<br />
FreeBSD Audio Driver (newpcm: 32bit 2009061500/i386)<br />
Installed devices:<br />
pcm0: <hda Realtek ALC883 PCM #0 Analog> at cad 0 nid 1 on hdac0 kld snd_hda [MPSAFE] (1p:1v/1r:1v channels duplex default)<br />
pcm1: </hda><hda Realtek ALC883 PCM #1 Analog> at cad 0 nid 1 on hdac0 kld snd_hda [MPSAFE] (1p:1v/0r:0v channels simplex)<br />
pcm2: </hda><hda Realtek ALC883 PCM #2 Digital> at cad 0 nid 1 on hdac0 kld snd_hda [MPSAFE] (1p:1v/0r:0v channels simplex)<br />
</hda>`

Add the lines in **/boot/loader.conf**
...
`hw.snd.default_unit=1` can be loaded from **sysctl**:

> `<br />
sysctl hw.snd.default_unit=1<br />
`
